...
export const languageNames: Map<string, LanguageName> = new Map([
    ...
    ['amharic',{chinese: '阿姆哈拉语', origin: 'Amharic', rtl: false, key: 'Amharic', english: 'Amharic'}],
    ['azeri',{chinese: '阿塞拜疆语', origin: 'Azeri', rtl: false, key: 'Azeri', english: 'Azeri'}],
    ['Bosnian',{chinese: '波斯尼亚语', origin: 'Bosnian', rtl: false, key: 'Bosnian', english: 'Bosnian'}],
    ['Catalan',{chinese: '加泰罗尼亚语', origin: 'Catalan', rtl: false, key: 'Catalan', english: 'Catalan'}],
    ['Welsh',{chinese: '威尔士语', origin: 'Welsh', rtl: false, key: 'Welsh', english: 'Welsh'}],
    ['Danish',{chinese: '丹麦语', origin: 'Danish', rtl: false, key: 'Danish', english: 'Danish'}],
    ['Estonian',{chinese: '爱沙尼亚语', origin: 'Estonian', rtl: false, key: 'Estonian', english: 'Estonian'}],
    ['Basque',{chinese: '巴斯克语', origin: 'Basque', rtl: false, key: 'Basque', english: 'Basque'}],
    ['Finnish',{chinese: '芬兰语', origin: 'Finnish', rtl: false, key: 'Finnish', english: 'Finnish'}],
    ['Irish',{chinese: '爱尔兰语', origin: 'Irish', rtl: false, key: 'Irish', english: 'Irish'}],
    ['Galician',{chinese: '加利西亚语', origin: 'Galician', rtl: false, key: 'Galician', english: 'Galician'}],
    ['Gujarati',{chinese: '古吉拉特语', origin: 'Gujarati', rtl: false, key: 'Gujarati', english: 'Gujarati'}],
    ['Armenian',{chinese: '亚美尼亚语', origin: 'Armenian', rtl: false, key: 'Armenian', english: 'Armenian'}],
    ['Icelandic',{chinese: '冰岛语', origin: 'Icelandic', rtl: false, key: 'Icelandic', english: 'Icelandic'}],
    ['Javanese',{chinese: '爪哇语', origin: 'Javanese', rtl: false, key: 'Javanese', english: 'Javanese'}],
    ['Georgian',{chinese: '格鲁吉亚语', origin: 'Georgian', rtl: false, key: 'Georgian', english: 'Georgian'}],
    ['Kazakh',{chinese: '哈萨克语', origin: 'Kazakh', rtl: false, key: 'Kazakh', english: 'Kazakh'}],
    ['Khmer',{chinese: '高棉语', origin: 'Khmer', rtl: false, key: 'Khmer', english: 'Khmer'}],
    ['Kannada',{chinese: '卡纳达语', origin: 'Kannada', rtl: false, key: 'Kannada', english: 'Kannada'}],
    ['Lao',{chinese: '老挝语', origin: 'Lao', rtl: false, key: 'Lao', english: 'Lao'}],
    ['Lithuanian',{chinese: '立陶宛语', origin: 'Lithuanian', rtl: false, key: 'Lithuanian', english: 'Lithuanian'}],
    ['Latvian',{chinese: '拉脱维亚语', origin: 'Latvian', rtl: false, key: 'Latvian', english: 'Latvian'}],
    ['Macedonian',{chinese: '马其顿语', origin: 'Macedonian', rtl: false, key: 'Macedonian', english: 'Macedonian'}],
    ['Marathi',{chinese: '马拉地语', origin: 'Marathi', rtl: false, key: 'Marathi', english: 'Marathi'}],
    ['Maltese',{chinese: '马耳他语', origin: 'Maltese', rtl: false, key: 'Maltese', english: 'Maltese'}],
