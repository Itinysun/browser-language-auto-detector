export const languageNames:Map<string, LanguageName>= new Map([
    ...
    ['cantonese', { chinese: '中文(繁体)', origin: '中文(繁體)', rtl: false, key: 'cantonese', english: 'Chinese (Traditional)' }],
    ...
    ['indonesian', {chinese: '印尼语',origin: 'bahasa Indonesia',rtl: false,key: 'indonesian', english: 'Indonesian'}],
